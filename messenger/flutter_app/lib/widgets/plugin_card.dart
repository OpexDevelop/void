              ...
              child: Column(
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    runSpacing: 8,
                    children: [
                      PermissionBadge(label: 'Network', granted: p.permissions.network),
                      PermissionBadge(label: 'Filesystem', granted: p.permissions.filesystem),
                      PermissionBadge(label: 'Contacts', granted: p.permissions.contacts),
                      PermissionBadge(label: 'Clipboard', granted: p.permissions.clipboard),
                      PermissionBadge(label: 'Notifications', granted: p.permissions.notifications),
                    ],
                  ),
